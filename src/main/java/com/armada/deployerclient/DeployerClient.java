...
public class DeployerClient {
    ...
    public static void main(String[] args) {
	    ...
	    String[] agentOneCommand = { "java","-jar", "/opt/lib/agent/agent.jar", "TESTdeployer-johntestagent"};
	    String[] agentTwoCommand = { "java","-jar", "/opt/lib/agent/agent.jar", "TESTdeployer-classtest-2"};
	    String[] agentThreeCommand = { "java","-jar", "/opt/lib/agent/agent.jar", "TESTdeployer-classtest-3"};

	    String containerOneId = dockerService.createContainer(
				"armadaproject/agent-prod",
				"TESTdeployer-classtest-1", agentOneCommand);
	    String containerTwoId = dockerService.createContainer(
			    "armadaproject/agent-prod",
			    "TESTdeployer-classtest-2", agentTwoCommand);
	    String containerThreeId = dockerService.createContainer(
			    "armadaproject/agent-prod",
			    "TESTdeployer-classtest-3", agentThreeCommand);
